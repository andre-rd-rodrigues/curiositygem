  ...
  return (
    <PageContainer className={styles.container}>
      ...
      <p>
        ...
        website operated by André Rodrigues. By accessing or using our Website,
      ...
      <p>
        Users are not allowed to publish any posts, articles, or comments on our
        Website. The Website is only for reading articles. You agree to use our
        Website only for lawful purposes and in a manner that does not infringe
        on the rights of others. You are solely responsible for your conduct on
        our Website, and we reserve the right to terminate your access to our
      ...
      <p>
        ...
        or controlled by Curiosity Gem. We have no control over, and assume no
        responsibility for, the content, privacy policies, or practices of any
        third-party websites. By using our Website, you acknowledge and agree
        that we shall not be responsible or liable, directly or indirectly, for

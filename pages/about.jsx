      ...
      <div className={styles.container}>
        ...
        <Row className={styles.section1}>
          <Col lg={6} md={6} sm={12}>
            ...
            <p>
              ...
              <Link href="/article/search?category=finance">wellbeing</Link> and
              more!
            </p>
            <p>
              ...
              you&apos;re looking to improve your finances, stay up-to-date with
              the latest technology trends, or simply want to live a healthier
        ...
        <Row className={styles.section2}>
          ...
          <Col lg={6} md={{ span: 6, order: 2 }} sm={{ span: 12, order: 1 }}>
            <p>
              Our team of writers are experts in their fields and are passionate
              about sharing their knowledge with you. We know that the internet
              can be overwhelming with information, so we&apos;ve made sure to
              keep our articles <b>easy to read</b> and understand. No fancy
              jargon or confusing terminology here, just plain and simple
              explanations of complex topics.
            </p>
            <p>
              We&apos;re constantly adding <b>new articles</b> and updating our
              existing ones, so make sure to check back often! And if you have
              any suggestions or topics you&apos;d like us to cover, don&apos;t
              hesitate to reach out. We love hearing from our readers and are
              always looking for ways to improve.
            </p>
            <p>
              Thanks for stopping by, and we hope you enjoy exploring the world
              with us here at <Link href="/">Curiosity Gem!</Link>
            </p>
          </Col>
        </Row>
      </div>

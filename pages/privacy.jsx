...
function Privacy() {
  return (
    <PageContainer className={styles.container}>
      ...
      <p>
        We only collect the personal information that you voluntarily provide to
        us, such as your name and email address when you subscribe to our
        newsletter. We use this information to send you our newsletter and other
        relevant updates. We do not share your personal information with any
        third parties, except as required by law. We also use Google Analytics
        to analyze the usage of our website. Google Analytics collects
        information about your use of our website, such as the pages you visit,
        your browser type, your IP address, and your geographic location. We use
        this information to improve our website and better understand our
        audience. Google Analytics may also use cookies to collect and store
        information about your usage. You can learn more about how Google uses
        your data by visiting their Privacy Policy page.
      </p>
      <h2>Cookies</h2>
      <p>
      ...
      <p>
        ...
        internet transmission is completely secure, and we cannot guarantee the
